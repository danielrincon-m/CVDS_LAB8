...
public interface ServiciosAlquiler {
     ...
     * @throws ExcepcionServiciosAlquiler si el item no existe o no esta actualmente
     *                                    alquilado
     */
     ...
     * @throws ExcepcionXX si el identificador no corresponde con un item, o si el
     *                     mismo ya esta alquilado
     */
     ...
     * @return el costo total del alquiler, teniendo en cuesta el costo diario y el
     *         numeo de dias del alquiler
